...
void rt_OneStep(void)
{
   ...
   */
  model2_SetEventsForThisBaseStep(eventFlags);
  ...
  for (i = 2; i < 4; i++) {
    ...
    if (need2runFlags[i]) {
      ...
      {
       case 2 :
        currentTime = (extmodeSimulationTime_T) ((model2_M->Timing.clockTick2 *
          5) + 0)
          ;
        model2_step2();
       ...
       case 3 :
        currentTime = (extmodeSimulationTime_T) ((model2_M->Timing.clockTick3 *
          500) + 0)
          ;
        model2_step3();
...
int main(void)
{
  ...
  init();
  MW_Arduino_Init();
  rtmSetErrorStatus(model2_M, 0);

  /* Set Final Simulation Time in Ticks */
  errorCode = extmodeSetFinalSimulationTime((extmodeSimulationTime_T) 5000000);
  ...
  errorCode = extmodeInit(model2_M->extModeInfo, (extmodeSimulationTime_T *)
    rteiGetPtrTFinalTicks(model2_M->extModeInfo));
  if (errorCode != EXTMODE_SUCCESS) {
  ...
  if (errorCode == EXTMODE_SUCCESS) {
    ...
    if (extmodeStopRequested()) {
      rtmSetStopRequested(model2_M, true);
    }
  }
