...
typedef struct {
  ...
  real_T Kd;                           /* '<Root>/Kd' */
  real_T TmpRTBAtDerivative2Inport1;   /* '<Root>/Add1' */
  real_T Kd1;                          /* '<Root>/Kd1' */
  real_T TmpRTBAtIntegrator1Inport1;   /* '<Root>/Add1' */
  ...
  uint8_T byteL1;                      /* '<Root>/MATLAB Function' */
  uint8_T byteL2;                      /* '<Root>/MATLAB Function' */
  uint8_T byteR1;                      /* '<Root>/MATLAB Function' */
  uint8_T byteR2;                      /* '<Root>/MATLAB Function' */
  boolean_T valid;                     /* '<Root>/Arduino Input2' */
} B_model2_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  codertarget_arduinobase_int_d_T obj; /* '<S4>/Serial Transmit2' */
...
struct P_model2_T_ {
  ...
  real_T slope_gain_Gain;              /* Expression: 5
                                        ...
                                        */
  real_T steer_gain_Gain;              /* Expression: 10
...
struct tag_RTM_model2_T {
  ...
  X_model2_T *contStates;
  int_T *periodicContStateIndices;
  real_T *periodicContStateRanges;
  real_T *derivs;
  XDis_model2_T *contStateDisabled;
...
/* Continuous states (default storage) */
extern X_model2_T model2_X;

/* Disabled states (default storage) */
extern XDis_model2_T model2_XDis;

/* Block states (default storage) */
extern DW_model2_T model2_DW;

/* External function called from main */
extern void model2_SetEventsForThisBaseStep(boolean_T *eventFlags);

/* Model entry point functions */
extern void model2_initialize(void);
extern void model2_step0(void);
extern void model2_step2(void);        /* Sample time: [0.0005s, 0.0s] */
extern void model2_step3(void);        /* Sample time: [0.05s, 0.0s] */
 ...
 *
 * '<Root>' : 'model2'
 * '<S1>'   : 'model2/Arduino Input1'
 * '<S2>'   : 'model2/Arduino Input2'
 * '<S3>'   : 'model2/MATLAB Function'
 * '<S4>'   : 'model2/Subsystem'
 * '<S5>'   : 'model2/Subsystem/Arduino output1'
 */
#endif                                 /* model2_h_ */
