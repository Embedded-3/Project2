 ...
 *
 * File: car_speed_control_uart_proto2_2.h
 *
...
#ifndef car_speed_control_uart_proto2_2_h_
#define car_speed_control_uart_proto2_2_h_
#ifndef car_speed_control_uart_proto2_2_COMMON_INCLUDES_
#define car_speed_control_uart_proto2_2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                    /* car_speed_control_uart_proto2_2_COMMON_INCLUDES_ */

#include "car_speed_control_uart_proto2_2_types.h"
...
#define car_speed_control_uart_proto2_2_M (car_speed_control_uart_proto_M)
...
typedef struct {
  ...
  uint16_T byteL1;                     /* '<Root>/MATLAB Function' */
  uint16_T byteL2;                     /* '<Root>/MATLAB Function' */
  uint16_T byteR1;                     /* '<Root>/MATLAB Function' */
  uint16_T byteR2;                     /* '<Root>/MATLAB Function' */
  ...
  uint8_T data_out[10];                /* '<Root>/Arduino Input1' */
...
typedef struct {
  codertarget_arduinobase_int_g_T obj; /* '<S4>/Serial Transmit2' */
...
extern void car_speed_control_uart_proto2_2_SetEventsForThisBaseStep(boolean_T
  *eventFlags);

/* Model entry point functions */
extern void car_speed_control_uart_proto2_2_initialize(void);
extern void car_speed_control_uart_proto2_2_step0(void);
extern void car_speed_control_uart_proto2_2_step2(void);/* Sample time: [0.1s, 0.0s] */
extern void car_speed_control_uart_proto2_2_terminate(void);
 ...
 *
 * '<Root>' : 'car_speed_control_uart_proto2_2'
 * '<S1>'   : 'car_speed_control_uart_proto2_2/Arduino Input1'
 * '<S2>'   : 'car_speed_control_uart_proto2_2/Arduino Input2'
 * '<S3>'   : 'car_speed_control_uart_proto2_2/MATLAB Function'
 * '<S4>'   : 'car_speed_control_uart_proto2_2/Subsystem'
 * '<S5>'   : 'car_speed_control_uart_proto2_2/Subsystem/Arduino output1'
 */
#endif                                 /* car_speed_control_uart_proto2_2_h_ */
