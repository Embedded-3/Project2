###########################################################################
## Makefile generated for component 'car_speed_control_uart_proto2_2'. 
## 
## Makefile     : car_speed_control_uart_proto2_2.mk
## Generated on : Sun May 25 16:19:33 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/car_speed_control_uart_proto2_2.elf
...
PRODUCT_NAME              = car_speed_control_uart_proto2_2
MAKEFILE                  = car_speed_control_uart_proto2_2.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/car_speed_control_uart_proto2_2.elf
...
DEFINES_STANDARD = -DMODEL=car_speed_control_uart_proto2_2 -DNUMST=3 -DNCSTATES=2 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SerialRead.o MW_SerialWrite.o xcp_ext_mode.o car_speed_control_uart_proto2_2.o car_speed_control_uart_proto2_2_data.o rtGetInf.o rtGetNaN.o rt_nonfinite.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o arduinoAVRScheduler.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/car_speed_control_uart_proto2_2_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/car_speed_control_uart_proto2_2_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/car_speed_control_uart_proto2_2_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
car_speed_control_uart_proto2_2.o : $(START_DIR)/car_speed_control_uart_proto2_2_ert_rtw/car_speed_control_uart_proto2_2.c
	$(CC) $(CFLAGS) -o "$@" "$<"


car_speed_control_uart_proto2_2_data.o : $(START_DIR)/car_speed_control_uart_proto2_2_ert_rtw/car_speed_control_uart_proto2_2_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/car_speed_control_uart_proto2_2_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.o : $(START_DIR)/car_speed_control_uart_proto2_2_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.o : $(START_DIR)/car_speed_control_uart_proto2_2_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/car_speed_control_uart_proto2_2_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
