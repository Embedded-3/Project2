...
void rt_OneStep(void)
{
   ...
   */
  car_speed_control_uart_proto2_2_SetEventsForThisBaseStep(eventFlags);
    ...
    switch (2)
    {
     case 2 :
      currentTime = (extmodeSimulationTime_T)
        ((car_speed_control_uart_proto_M->Timing.clockTick2 * 100) + 0)
        ;
      car_speed_control_uart_proto2_2_step2();
...
int main(void)
{
  ...
  car_speed_control_uart_proto2_2_initialize();
  cli();
  sei();
  ...
  /* Terminate model */
  car_speed_control_uart_proto2_2_terminate();
