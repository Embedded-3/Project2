 ...
 *
 * File: car_speed_control_uart_proto1.c
 *
...
#include <stddef.h>
#include <math.h>
#include "car_speed_control_uart_proto1_private.h"
#include "rt_nonfinite.h"

/* Block signals (default storage) */
B_car_speed_control_uart_prot_T car_speed_control_uart_proto1_B;

/* Continuous states */
X_car_speed_control_uart_prot_T car_speed_control_uart_proto1_X;
...
static real_T car_speed_control_uart_pr_mod_p(real_T x);
 ...
 */
void car_speed_control_uart_proto1_SetEventsForThisBaseStep(boolean_T
  *eventFlags)
{
...
static void rate_monotonic_scheduler(void)
{
  ...
  if ((car_speed_control_uart_proto_M->Timing.TaskCounters.TID[2]) > 9) {/* Sample time: [0.1s, 0.0s] */
    car_speed_control_uart_proto_M->Timing.TaskCounters.TID[2] = 0;
  }
}
...
static void rt_ertODEUpdateContinuousStates(RTWSolverInfo *si )
{
  ...
  /* f0 = f(t,y) */
  rtsiSetdX(si, f0);
  car_speed_control_uart_proto1_derivatives();
...
void car_speed_control_uart_proto1_step0(void) /* Sample time: [0.0s, 0.0s] */
{
...

  {
    ...
    uint8_T tmp_1;
    boolean_T tmp_0;
    tmp_0 = rtmIsMajorTimeStep(car_speed_control_uart_proto_M);
    if (tmp_0) {
      /* MATLABSystem: '<Root>/Serial Receive1' */
      MW_Serial_read(1, 1U, &car_speed_control_uart_proto1_B.SerialReceive1_o1,
                     &car_speed_control_uart_proto1_B.SerialReceive1_o2, NULL,
                     0.0, NULL, 0.0);

      /* MATLAB Function: '<Root>/Arduino Input1' */
      car_speed_control_uart_proto1_B.ready = false;
      for (i = 0; i < 10; i++) {
        data_out[i] = 0U;
      }

      if (car_speed_control_uart_proto1_B.SerialReceive1_o2 == 1) {
        if (!car_speed_control_uart_proto_DW.collecting) {
          if (car_speed_control_uart_proto1_B.SerialReceive1_o1 == 170) {
            car_speed_control_uart_proto_DW.buffer[0] =
              car_speed_control_uart_proto1_B.SerialReceive1_o1;
          ...
          if (car_speed_control_uart_proto_DW.count == 10.0) {
            ...
            car_speed_control_uart_proto1_B.ready = true;
      ...
      if (car_speed_control_uart_proto1_B.ready) {
        car_speed_control_uart_proto_DW.p_valid = true;
        car_speed_control_uart_proto_DW.p_speed_L = ((real_T)data_out[2] / 100.0
          + (real_T)data_out[1]) * 10.0;
        car_speed_control_uart_proto_DW.p_speed_R = ((real_T)data_out[4] / 100.0
          + (real_T)data_out[3]) * 10.0;
        car_speed_control_uart_proto_DW.p_v_target = (real_T)data_out[5] * 10.0;
        car_speed_control_uart_proto_DW.p_slope = data_out[6];
        tmp_1 = data_out[7];
        if (data_out[7] > 127) {
          tmp_1 = 127U;
        }

        car_speed_control_uart_proto_DW.p_steer = (int8_T)tmp_1;
      }

      car_speed_control_uart_proto1_B.valid =
        car_speed_control_uart_proto_DW.p_valid;
      car_speed_control_uart_proto1_B.speed_L =
        car_speed_control_uart_proto_DW.p_speed_L;
      car_speed_control_uart_proto1_B.speed_R =
        car_speed_control_uart_proto_DW.p_speed_R;
      car_speed_control_uart_proto1_B.v_target =
        car_speed_control_uart_proto_DW.p_v_target;
      car_speed_control_uart_proto1_B.slope =
        car_speed_control_uart_proto_DW.p_slope;
      car_speed_control_uart_proto1_B.steer =
        car_speed_control_uart_proto_DW.p_steer;

      /* End of MATLAB Function: '<Root>/Arduino Input2' */
      /* Gain: '<Root>/V_gain' */
      i = car_speed_control_uart_proto1_P.V_gain_Gain *
        car_speed_control_uart_proto1_B.steer;
       ...
       *  Sum: '<Root>/Sum2'
       */
      car_speed_control_uart_proto1_B.error = ((real_T)i * 0.0625 +
        car_speed_control_uart_proto1_B.v_target) -
        car_speed_control_uart_proto1_B.speed_L;
    }
     ...
     */
    tmp = car_speed_control_uart_proto_M->Timing.t[0];
    if ((car_speed_control_uart_proto_DW.TimeStampA >= tmp) &&
        (car_speed_control_uart_proto_DW.TimeStampB >= tmp)) {
      rtb_Integrator1 = 0.0;
    } else {
      ...
      if (car_speed_control_uart_proto_DW.TimeStampA <
        ...
        if (car_speed_control_uart_proto_DW.TimeStampB < tmp) {
          rtb_Integrator1 = car_speed_control_uart_proto_DW.TimeStampB;
          lastU = &car_speed_control_uart_proto_DW.LastUAtTimeB;
        }
      } else if (car_speed_control_uart_proto_DW.TimeStampA >= tmp) {
        rtb_Integrator1 = car_speed_control_uart_proto_DW.TimeStampB;
        lastU = &car_speed_control_uart_proto_DW.LastUAtTimeB;
      }

      rtb_Integrator1 = (car_speed_control_uart_proto1_B.error - *lastU) / (tmp
        - rtb_Integrator1);
    }
    ...
    if (tmp_0) {
      if (car_speed_control_uart_proto_M->Timing.RateInteraction.TID1_2) {
        car_speed_control_uart_proto_DW.TmpRTBAtSubsystemInport1_Buffer =
          ((car_speed_control_uart_proto1_P.Kp_Gain *
            car_speed_control_uart_proto1_B.error +
            car_speed_control_uart_proto1_P.Ki_Gain *
            car_speed_control_uart_proto1_X.Integrator_CSTATE) +
           car_speed_control_uart_proto1_P.Kd_Gain * rtb_Integrator1) *
          car_speed_control_uart_proto1_P.Gain_Gain;
      }
       ...
       *  Sum: '<Root>/Sum3'
       */
      car_speed_control_uart_proto1_B.error_j =
        (car_speed_control_uart_proto1_B.v_target - (real_T)i * 0.0625) -
        car_speed_control_uart_proto1_B.speed_R;
    }
    ...
    /* Derivative: '<Root>/Derivative2' */
    if ((car_speed_control_uart_proto_DW.TimeStampA_l >= tmp) &&
        (car_speed_control_uart_proto_DW.TimeStampB_i >= tmp)) {
      rtb_Integrator1 = 0.0;
    } else {
      ...
      if (car_speed_control_uart_proto_DW.TimeStampA_l <
        ...
        if (car_speed_control_uart_proto_DW.TimeStampB_i < tmp) {
          rtb_Integrator1 = car_speed_control_uart_proto_DW.TimeStampB_i;
          lastU = &car_speed_control_uart_proto_DW.LastUAtTimeB_o;
        }
      } else if (car_speed_control_uart_proto_DW.TimeStampA_l >= tmp) {
        rtb_Integrator1 = car_speed_control_uart_proto_DW.TimeStampB_i;
        lastU = &car_speed_control_uart_proto_DW.LastUAtTimeB_o;
      }

      rtb_Integrator1 = (car_speed_control_uart_proto1_B.error_j - *lastU) /
        (tmp - rtb_Integrator1);
    }
    ...
    if (tmp_0) {
      if (car_speed_control_uart_proto_M->Timing.RateInteraction.TID1_2) {
        car_speed_control_uart_proto_DW.TmpRTBAtSubsystemInport2_Buffer =
          ((car_speed_control_uart_proto1_P.Kp1_Gain *
            car_speed_control_uart_proto1_B.error_j +
            car_speed_control_uart_proto1_P.Ki1_Gain *
            car_speed_control_uart_proto1_X.Integrator1_CSTATE) +
           car_speed_control_uart_proto1_P.Kd1_Gain * rtb_Integrator1) *
          car_speed_control_uart_proto1_P.Gain1_Gain;
      }
    }
  ...
  if (rtmIsMajorTimeStep(car_speed_control_uart_proto_M)) {
    ...
    *lastU = car_speed_control_uart_proto1_B.error;
    ...
    *lastU = car_speed_control_uart_proto1_B.error_j;
...
void car_speed_control_uart_proto1_derivatives(void)
{
  ...
  _rtXdot->Integrator_CSTATE = car_speed_control_uart_proto1_B.error;

  /* Derivatives for Integrator: '<Root>/Integrator1' */
  _rtXdot->Integrator1_CSTATE = car_speed_control_uart_proto1_B.error_j;
}

/* Model step function for TID2 */
void car_speed_control_uart_proto1_step2(void) /* Sample time: [0.1s, 0.0s] */
{
  real_T tmp;
  real_T tmp_0;
  real_T tmp_1;
   ...
   * */
  tmp_1 = floor(car_speed_control_uart_proto_DW.TmpRTBAtSubsystemInport1_Buffer);
  if (tmp_1 < 256.0) {
    if (tmp_1 >= 0.0) {
  ...
  tmp_0 = floor(car_speed_control_uart_prot_mod
                (car_speed_control_uart_proto_DW.TmpRTBAtSubsystemInport1_Buffer
                 * 100.0));
  if (tmp_0 < 256.0) {
    if (tmp_0 >= 0.0) {
  ...
  tmp_0 = floor(car_speed_control_uart_proto_DW.TmpRTBAtSubsystemInport2_Buffer);
  if (tmp_0 < 256.0) {
    if (tmp_0 >= 0.0) {
  ...
  tmp = floor(car_speed_control_uart_prot_mod
              (car_speed_control_uart_proto_DW.TmpRTBAtSubsystemInport2_Buffer *
               100.0));
  if (tmp < 256.0) {
    if (tmp >= 0.0) {
  ...
  tmp_1 = rt_roundd_snf(car_speed_control_uart_pr_mod_p(256.0 -
    car_speed_control_uart_pr_mod_p((real_T)(((varargin_9 + frame[1]) +
    varargin_10) + frame[3]))));
  if (tmp_1 < 256.0) {
    if (tmp_1 >= 0.0) {
  ...
  varargin_9 = 85U;
  varargin_10 = 170U;
  MW_Serial_write(car_speed_control_uart_proto_DW.obj.port, &frame[0], 5.0,
...
void car_speed_control_uart_proto1_initialize(void)
{
  /* Registration code */
  ...
  car_speed_control_uart_proto_M->contStates = ((X_car_speed_control_uart_prot_T
    *) &car_speed_control_uart_proto1_X);
  ...
  car_speed_control_uart_proto_M->Timing.stepSize0 = 0.01;

  /* External mode info */
  car_speed_control_uart_proto_M->Sizes.checksums[0] = (2920983724U);
  car_speed_control_uart_proto_M->Sizes.checksums[1] = (4223385677U);
  car_speed_control_uart_proto_M->Sizes.checksums[2] = (1779455898U);
  car_speed_control_uart_proto_M->Sizes.checksums[3] = (594916950U);

  {
    ...
    rteiSetTFinalTicks(car_speed_control_uart_proto_M->extModeInfo, 30000);
  }
  ...
  car_speed_control_uart_proto1_X.Integrator_CSTATE =
    car_speed_control_uart_proto1_P.Integrator_IC;
  ...
  car_speed_control_uart_proto1_X.Integrator1_CSTATE =
    car_speed_control_uart_proto1_P.Integrator1_IC;
...
void car_speed_control_uart_proto1_terminate(void)
{
