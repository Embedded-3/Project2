...
typedef struct {
  ...
  real_T speed_L_Buffer;               /* synthesized block */
  real_T speed_R_Buffer;               /* synthesized block */
...
extern void UART_test_step0(void);     /* Sample time: [0.001s, 0.0s] */
extern void UART_test_step1(void);     /* Sample time: [0.01s, 0.0s] */
extern void UART_test_step2(void);     /* Sample time: [0.1s, 0.0s] */
