 ...
 *
 * File: car_speed_control_uart_proto2.h
 *
...
#ifndef car_speed_control_uart_proto2_h_
#define car_speed_control_uart_proto2_h_
#ifndef car_speed_control_uart_proto2_COMMON_INCLUDES_
#define car_speed_control_uart_proto2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                      /* car_speed_control_uart_proto2_COMMON_INCLUDES_ */

#include "car_speed_control_uart_proto2_types.h"
...
#define car_speed_control_uart_proto2_M (car_speed_control_uart_proto_M)

/* Block signals (default storage) */
typedef struct {
  real_T TmpRTBAtSumInport1;           /* '<Root>/Kp' */
  real_T error;                        /* '<Root>/Add' */
  real_T TmpRTBAtSum1Inport1;          /* '<Root>/Kp1' */
  real_T error_g;                      /* '<Root>/Add1' */
  real_T error_gd;                     /* '<Root>/Add1' */
  real_T error_gdy;                    /* '<Root>/Add' */
  ...
  uint8_T start;                       /* '<Root>/Arduino Input2' */
  uint8_T slope;                       /* '<Root>/Arduino Input2' */
  uint8_T crc;                         /* '<Root>/Arduino Input2' */
  uint8_T fin;                         /* '<Root>/Arduino Input2' */
...
typedef struct {
  ...
  real_T TmpRTBAtSum1Inport1_Buffer0;  /* synthesized block */
  real_T TmpRTBAtDerivative2Inport1_Buff;/* synthesized block */
  ...
  real_T TmpRTBAtIntegrator1Inport1_Buff;/* synthesized block */
  ...
  uint16_T byteL1_Buffer;              /* synthesized block */
  uint16_T byteL2_Buffer;              /* synthesized block */
  uint16_T byteR1_Buffer;              /* synthesized block */
  uint16_T byteR2_Buffer;              /* synthesized block */
  int8_T p_steer;                      /* '<Root>/Arduino Input2' */
  uint8_T p_start;                     /* '<Root>/Arduino Input2' */
  uint8_T p_slope;                     /* '<Root>/Arduino Input2' */
  uint8_T p_crc;                       /* '<Root>/Arduino Input2' */
  uint8_T p_fin;                       /* '<Root>/Arduino Input2' */
...
struct P_car_speed_control_uart_prot_T_ {
  ...
  real_T TmpRTBAtSumInport1_InitialCondi;/* Expression: 0
                                          * Referenced by:
                                          */
  real_T error_InitialCondition;       /* Expression: 0
                                        * Referenced by:
                                        */
  real_T Kd_Gain;                      /* Expression: 0
                                        * Referenced by: '<Root>/Kd'
                                        */
  real_T TmpRTBAtSum1Inport1_InitialCond;/* Expression: 0
                                          * Referenced by:
                                          */
  real_T TmpRTBAtDerivative2Inport1_Init;/* Expression: 0
                                          * Referenced by:
                                          */
  ...
  real_T Ki1_Gain;                     /* Expression: 0
                                        ...
                                        */
  real_T TmpRTBAtIntegrator1Inport1_Init;/* Expression: 0
                                          * Referenced by:
                                          */
...
extern P_car_speed_control_uart_prot_T car_speed_control_uart_proto2_P;

/* Block signals (default storage) */
extern B_car_speed_control_uart_prot_T car_speed_control_uart_proto2_B;

/* Continuous states (default storage) */
extern X_car_speed_control_uart_prot_T car_speed_control_uart_proto2_X;
...
extern void car_speed_control_uart_proto2_SetEventsForThisBaseStep(boolean_T
  *eventFlags);

/* Model entry point functions */
extern void car_speed_control_uart_proto2_initialize(void);
extern void car_speed_control_uart_proto2_step0(void);
extern void car_speed_control_uart_proto2_step2(void);/* Sample time: [0.001s, 0.0s] */
extern void car_speed_control_uart_proto2_step3(void);/* Sample time: [0.1s, 0.0s] */
extern void car_speed_control_uart_proto2_terminate(void);
 ...
 *
 * '<Root>' : 'car_speed_control_uart_proto2'
 * '<S1>'   : 'car_speed_control_uart_proto2/Arduino Input1'
 * '<S2>'   : 'car_speed_control_uart_proto2/Arduino Input2'
 * '<S3>'   : 'car_speed_control_uart_proto2/MATLAB Function'
 * '<S4>'   : 'car_speed_control_uart_proto2/Subsystem'
 * '<S5>'   : 'car_speed_control_uart_proto2/Subsystem/Arduino output1'
 */
#endif                                 /* car_speed_control_uart_proto2_h_ */
