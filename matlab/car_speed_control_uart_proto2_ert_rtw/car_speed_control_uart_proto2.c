 ...
 * C/C++ source code generated on : Fri May 23 18:32:13 2025
 *
...

  {
    ...
    if (tmp_0) {
      ...
      if (car_speed_control_uart_proto2_B.SerialReceive1_o2 == 1) {
        if (!car_speed_control_uart_proto_DW.collecting) {
          ...
          if (car_speed_control_uart_proto_DW.count == 10.0) {
            for (i = 0; i < 10; i++) {
              rtb_data_out[i] = car_speed_control_uart_proto_DW.buffer[i];
            }
      ...
      if (car_speed_control_uart_proto2_B.ready) {
        ...
        car_speed_control_uart_proto_DW.p_speed_L = ((real_T)rtb_data_out[2] /
          100.0 + (real_T)rtb_data_out[1]) * 10.0;
        car_speed_control_uart_proto_DW.p_speed_R = ((real_T)rtb_data_out[4] /
          100.0 + (real_T)rtb_data_out[3]) * 10.0;
        car_speed_control_uart_proto_DW.p_v_target = (real_T)rtb_data_out[5] *
          10.0;
        car_speed_control_uart_proto_DW.p_slope = rtb_data_out[6];
        tmp_3 = rtb_data_out[7];
        if (rtb_data_out[7] > 127) {
          tmp_3 = 127U;
        }

        car_speed_control_uart_proto_DW.p_steer = (int8_T)tmp_3;
      }
       ...
       *  Sum: '<Root>/Sum2'
       */
      car_speed_control_uart_proto2_B.error = ((real_T)i * 0.0625 +
        car_speed_control_uart_proto2_B.v_target) -
        car_speed_control_uart_proto2_B.speed_L;
    }
    ...
    if ((car_speed_control_uart_proto_DW.TimeStampA >= tmp) &&
      ...
      rtb_Integrator1 = (car_speed_control_uart_proto2_B.error - *lastU) / (tmp
        - rtb_Integrator1);
    }
    ...
    if (tmp_0) {
      ...
      car_speed_control_uart_proto2_B.error_j =
        (car_speed_control_uart_proto2_B.v_target - (real_T)i * 0.0625) -
        car_speed_control_uart_proto2_B.speed_R;
    }
    ...
    if ((car_speed_control_uart_proto_DW.TimeStampA_l >= tmp) &&
      ...
      rtb_Integrator1 = (car_speed_control_uart_proto2_B.error_j - *lastU) /
        (tmp - rtb_Integrator1);
    }
     ...
     *  Sum: '<Root>/Sum1'
     */
    tmp = rt_roundd_snf(((car_speed_control_uart_proto2_P.Ki_Gain *
                          car_speed_control_uart_proto2_X.Integrator_CSTATE +
                          car_speed_control_uart_proto2_B.Kp) + rtb_Kd) / 300.0 *
                        2000.0 + 2000.0);
    if (tmp < 65536.0) {
      if (tmp >= 0.0) {
        tmp_2 = (uint16_T)tmp;
    ...
    tmp = rt_roundd_snf(((car_speed_control_uart_proto2_P.Ki1_Gain *
                          car_speed_control_uart_proto2_X.Integrator1_CSTATE +
                          car_speed_control_uart_proto2_B.Kp1) +
                         car_speed_control_uart_proto2_P.Kd1_Gain *
                         rtb_Integrator1) / 300.0 * 2000.0 + 2000.0);
    if (tmp < 65536.0) {
      if (tmp >= 0.0) {
        tmp_1 = (uint16_T)tmp;
      } else {
    ...
    if (tmp_0) {
      if (car_speed_control_uart_proto_M->Timing.RateInteraction.TID1_2) {
        car_speed_control_uart_proto_DW.byteL1_Buffer = tmp_2 >> 8;

        /* RateTransition generated from: '<Root>/Subsystem' incorporates:
         *  MATLAB Function: '<Root>/MATLAB Function'
         */
        car_speed_control_uart_proto_DW.byteL2_Buffer = tmp_2 & 255U;

        /* RateTransition generated from: '<Root>/Subsystem' incorporates:
         *  MATLAB Function: '<Root>/MATLAB Function'
         */
        car_speed_control_uart_proto_DW.byteR1_Buffer = tmp_1 >> 8;

        /* RateTransition generated from: '<Root>/Subsystem' incorporates:
         *  MATLAB Function: '<Root>/MATLAB Function'
         */
        car_speed_control_uart_proto_DW.byteR2_Buffer = tmp_1 & 255U;
      }
    }
  }
...
void car_speed_control_uart_proto2_step2(void) /* Sample time: [0.1s, 0.0s] */
{
  real_T tmp;
  uint16_T tmp_0;
  uint8_T dataIn[5];
...
void car_speed_control_uart_proto2_initialize(void)
{
  ...
  /* External mode info */
  car_speed_control_uart_proto_M->Sizes.checksums[0] = (2917487220U);
  car_speed_control_uart_proto_M->Sizes.checksums[1] = (1475160512U);
  car_speed_control_uart_proto_M->Sizes.checksums[2] = (766761237U);
  car_speed_control_uart_proto_M->Sizes.checksums[3] = (2038028065U);
