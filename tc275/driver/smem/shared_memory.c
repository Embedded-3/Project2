...
volatile uint8 s_targetSpeedL __attribute__((section(".shared")));
volatile uint8 s_targetSpeedR __attribute__((section(".shared")));

volatile char   s_followAngle __attribute__((section(".shared")));

volatile uint16 s_distance    __attribute__((section(".shared")));

volatile uint8 s_speedL        __attribute__((section(".shared")));
volatile uint8 s_speedR        __attribute__((section(".shared")));
